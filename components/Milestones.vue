<template>
    <div class="container">
        <div class="relative my-32 md:my-24">
            <NuxtImg format="webp" loading="lazy" class="shadow-md rounded-md" src="/images/children-2.png" width="1300"
            ...
            <div v-if="donationData"
                ...
                <p class="font-bold  text-center text-2xl md:text-4xl text-white">${{
                    milestones[donationData.milestoneIndex] / 100 }}</p>
                ...
                <a href="https://buy.stripe.com/test_dR6dSgfG443o7rq3cc"
                    class="btn-primary bg-[#958ef1] w-full mt-2 text-center">Donate Now</a>
            </div>
        </div>
    </div>
</template>
