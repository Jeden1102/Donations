            ...
            <div class="bg-gray-100 rounded-md px-4 py-8 shadow-lg border  md:max-w-[426px] lg:px-10 dark:bg-gray-700 dark:border-0">
                ...
                <div class="flex gap-2 flex-wrap">
                    <div v-for="value in donationValues" :key="value">
                        ...
                        <label
                            class="dark:text-gray-200 donation-label w-20 h-14 cursor-pointer rounded-md border flex items-center justify-center bg-gray-50 dark:bg-gray-600 dark:border-gray-700 shadow-sm  peer-checked:bg-primary-light peer-checked:border-primary dark:peer-checked:bg-gray-400 dark:peer-checked:border-gray-500 dark:peer-checked:text-gray-100"
